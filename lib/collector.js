...
var Collector=function() {
  ...
  this.completedListener.bind(this.queueEvents.taskCompleted({})).catch(error => debug('Bind error: %s',error));
  this.failedListener.bind(this.queueEvents.taskFailed({})).catch(error => debug('Bind error: %s',error));
  this.exceptionListener.bind(this.queueEvents.taskException({})).catch(error => debug('Bind error: %s',error));
